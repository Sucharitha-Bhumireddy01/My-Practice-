Public Class frmProjectileMotion
    ...
    Private Sub ValidateInput(ByRef h As Double, ByRef v As Double)
        If IsNumeric(txtIntialHeight.Text) And IsNumeric(txtIntialVelocity.Text) Then
            h = CDbl(txtIntialHeight.Text)
            v = CDbl(txtIntialVelocity.Text)
        Else
            MessageBox.Show("Please correct your input", "Invalide Input", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
    End Sub
    ...
    Private Sub btnApproxTime_Click(sender As Object, e As EventArgs) Handles btnApproxTime.Click
        ...
        lstOutput.Items.Add("The ball will hit the ground after approximatly")
    ...
    Private Sub ShowTable(h As Double, v As Double)
        ...
        Do
            ...
            gridvwTable.Rows.Add(t.ToString("N"), height.ToString("N1"))
            t += 0.25
