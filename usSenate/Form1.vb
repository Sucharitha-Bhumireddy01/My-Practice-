Public Class frmUSSenate
    Private Sub frmUSSenate_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'determine number of senators for each party affilation
        ...
        'so ordering them by state will give us a pair of states fro each state
        ...
        'load the list if stated in the list box
