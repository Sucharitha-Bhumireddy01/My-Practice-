Public Class frmBalckJack
    Dim player, dealer As Hand 'two hands
    Dim WithEvents deck As DeckOfCards
    Private Sub frmBalckJack_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        player = New Hand()
        dealer = New Hand()
    ...
    Private Sub btnHitMe_Click(sender As Object, e As EventArgs) Handles btnHitMe.Click
        'Only hit if player has less then 5 cards, has nit yet nust and not held
    ...
    Private Sub Hold()
        'Deal one card to dealer until number reaches 5 or score reaches 5 or score reaches 17.
    ...
    Private Function Result() As String
        ...
        If dealer.LastStored = 5 Then
            Return "Dealer had reache 5 - Dealer Wins"
        End If
