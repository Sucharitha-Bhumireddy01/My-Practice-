Public Class DeckOfCards
    ...
    Public Sub New()
        'MAke the first thirteen cards hearts, then
        'next thirteen cards as diamonds, and so on
        Dim suits() As String = {"Hearts", "Diamonds", "Clubs", "Spades"}
        For i As Integer = 0 To 3
            For j As Integer = 1 To 13
                'Assign numbers from1 to 13 through the cards of each suit
    ...
    Private Sub Swap(i As Integer, j As Integer)
        'swap i-th card with the j-th card in the deck
    ...
    Public Sub ShuffleDeck()
        ...
        'swap each card with randomly selected card.
        ...
        For i As Integer = 1 To 2000
            For j As Integer = 1 To 52
                ...
                Swap(j, index)
            Next
            'Raise the shuffling event to track the prohgree of the shuffle.
