Public Class frmSeatingChart
    ...
    Dim frmAssign As New frmMeal()
    Private Sub frmSeatingChart_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lstRows.Items.Add(" ABC DEF ")
        For i As Integer = 1 To 15
            For j As Integer = 1 To 6
                seats(i, j) = "." 'add . to array but not list box
            Next
            lstRows.Items.Add(" ... ... ") 'populate listbox
        Next
    End Sub

    'updates the rows, every time a new row is assigned
    ...
    Private Sub Assign(seat As Integer)
        ...
        If row > 0 Then
            ...
            frmAssign.ShowDialog() 'going to frmMeal and choosing the meal type
            seats(row, seat) = frmAssign.seat 'after returning from meal form, assigning the selected meal to the seat
            UpdateRow(row)
    ...
    Private Sub btnDisplay_Click(sender As Object, e As EventArgs) Handles btnDisplay.Click
        Dim meals(3) As Integer 'index=3 because there sre 4 options in meals forms
        ...
        lstDisplay.Items.Add("Windows avaialble: " & window)
        lstDisplay.Items.Add("Regular Meals: " & meals(1))
        lstDisplay.Items.Add("Low Calarie Meals: " & meals(2))
