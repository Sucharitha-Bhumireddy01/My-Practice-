Public Class frmInventoryManagement
    ...
    Private Sub frmInventoryManagement_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MacrolandDataSet1.Orders' table. You can move, or remove it, as needed.
        Me.OrdersTableAdapter.Fill(Me.MacrolandDataSet1.Orders)
        'TODO: This line of code loads data into the 'MacrolandDataSet1.Inventory' table. You can move, or remove it, as needed.
        Me.InventoryTableAdapter.Fill(Me.MacrolandDataSet1.Inventory)
        'TODO: This line of code loads data into the 'MacrolandDataSet1.Customers' table. You can move, or remove it, as needed.
        Me.CustomersTableAdapter.Fill(Me.MacrolandDataSet1.Customers)
    End Sub
    Private Sub btnOutOfstock_Click(sender As Object, e As EventArgs) Handles btnOutOfstock.Click
        ...
        Dim query1 = From item In MacrolandDataSet1.Orders
                     Select item.itemID, item.quantity

        Dim query2 = From item In MacrolandDataSet1.Inventory
    ...
    Private Sub btnBills_Click(sender As Object, e As EventArgs) Handles btnBills.Click
        ...
        'list of customers who made a purchage
        Dim query1 = From cust In MacrolandDataSet1.Orders
                     Select cust.custID
                     Distinct

        For Each id In query1
            'list of customer names and addresses
            Dim query2 = From cust In MacrolandDataSet1.Customers
            ...
            Dim query3 = From product In MacrolandDataSet1.Orders
                         Join product2 In MacrolandDataSet1.Inventory
            ...
            lstOutput.Items.Add("______________________________________")
