Public Class frmSlotMachine
    ...
    Private Sub btnExit_Click(sender As Object, e As EventArgs) Handles btnExit.Click
        MessageBox.Show("You ended up with " + bankroll.ToString() + " dollars", "Game Over",
    ...
    Private Sub btnSpin_Click(sender As Object, e As EventArgs) Handles btnSpin.Click
        If bankroll = 0 Then
            MessageBox.Show("You are out of cash" + " dollars,", "Game Over", MessageBoxButtons.OK)
            Close()
        End If
    ...
    Private Sub timeDone_Tick(sender As Object, e As EventArgs) Handles timeDone.Tick
        ...
        'pick final picture and see if it is winner
