Public Class frmFurnitureOrder
    Const ChairPrice As Double = 5000
    Const SofaPrice As Double = 20000
    ...
    Private Function ValidateInput(custName As String, street As String, cityStateZip As String) As Boolean
        If Not custName.Contains(", ") Or custName.Length < 4 Then
            MessageBox.Show("Invalid Name.", " Make sure names are seperated by comma", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Return False
