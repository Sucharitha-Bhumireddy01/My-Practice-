Public Class frmProverbs
    'the first letter (T or F) shows if it is tru or false
    ...
    Const Seven As String = "TMarry in haste, repent in leisure."
    Dim counter As Integer = 0
    Dim correctAnswers As Integer
    Dim currentProverb As String

    Private Sub btnProverb_Click(sender As Object, e As EventArgs) Handles btnDisplay.Click
        counter += 1
        If counter <= 7 Then
            Proverbs()
