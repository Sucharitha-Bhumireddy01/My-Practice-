Public Class frmTelephoneDirectories
    ...
    Private Sub frmTelephoneDirectories_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAddListing_Click(sender As Object, e As EventArgs) Handles btnAddListing.Click
        ...
        Else
            MessageBox.Show("Select directory and enter name and phone to add", " Inavlid Entry", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End If
